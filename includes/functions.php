<?php 
	...
	*/
	function sideBarItem($categorie, $pagina_naam) {
		$pagina = strtolower($_GET['pagina']);
		if (isset($_GET['categorie']) && $categorie == $_GET['categorie']){
			if ($pagina_naam == $pagina)
			{
				?><li class="active"><a href="?categorie=<?php echo str_replace(' ', '_', strtolower($categorie)); ?>&pagina=<?php echo str_replace(' ', '_', strtolower($pagina_naam)); ?>"><?php echo ucfirst($pagina_naam); ?></a></li><?php
			}
			else 
			{
				?><li><a href="?categorie=<?php echo str_replace(' ', '_', strtolower($categorie)); ?>&pagina=<?php echo str_replace(' ', '_', strtolower($pagina_naam)); ?>"><?php echo ucfirst($pagina_naam); ?></a></li><?php
			}
		}
	...
	*/
	...
	// Functie voor het ophalen van alle waarden uit een aangegeven tabel. De naam moet overeen komen met die van de tabelnaam
